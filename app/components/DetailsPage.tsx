...
const DetailsPage: React.FC<DetailsPageProps> = ({
  ...
  const onAdditionalPickupInstructionsChange =
    details.onAdditionalPickupInstructionsChange;
  ...
  const onAdditionalDeliveryInstructionsChange =
    details.onAdditionalDeliveryInstructionsChange;
  ...
  const handleContinue = () => {
    ...
    if (Object.values(newErrors).every((error) => error === "")) {
      ...
      setErrors(newErrors);
      setTimeout(() => {
        const continueSection = document.getElementById(
          "details-continue-section"
        );
        if (continueSection) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
        ...
        <div>
          ...
          <label
            className={`input input-bordered flex items-center gap-2 mt-4 ${
              errors.pickupFromName ? "input-error" : ""
            }`}
          >
            <svg
          ...
          {errors.pickupFromName && (
            <p className="text-red-500 text-sm mt-1">{errors.pickupFromName}</p>
          )}

          {/* Pickup Email */}
          <label
            className={`input input-bordered flex items-center gap-2 mt-4 ${
              errors.pickupFromEmail ? "input-error" : ""
            }`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <label className="input input-bordered flex items-center gap-2 mt-4">
            <svg
              ...
              className="h-4 w-4 opacity-70"
            >
              <path d="M6.62 10.79a15.053 15.053 0 0 0 6.59 6.59l2.2-2.2a1 1 0 0 1 1.11-.21c1.12.45 2.33.69 3.58.69a1 1 0 0 1 1 1v3.5a1 1 0 0 1-1 1C10.07 22 2 13.93 2 4.5a1 1 0 0 1 1-1H6.5a1 1 0 0 1 1 1c0 1.25.24 2.46.69 3.58a1 1 0 0 1-.21 1.11l-2.2 2.2z" />
            </svg>
            <input
              type="text"
              className="grow"
          ...
          <div className="mt-2">
            ...
            >
              {showPickupInstructions ? "Hide" : "+ Add"} extra pickup
              instructions
            </button>
            <div
              className={`${showPickupInstructions ? "block" : "hidden"} mt-2`}
            >
              <textarea
                ...
                onChange={(e) =>
                  onAdditionalPickupInstructionsChange(e.target.value)
                }
              />
            </div>
          </div>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-4 text-gray-900">
            Deliver To <span className="badge badge-ghost">( Buyer )</span>
          </h2>
          <div className="flex items-center mt-2">
          ...
          <label
            className={`input input-bordered flex items-center gap-2 mt-4 ${
              errors.deliverToName ? "input-error" : ""
            }`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          {errors.deliverToName && (
            <p className="text-red-500 text-sm mt-1">{errors.deliverToName}</p>
          )}

          {/* Deliver To Email */}
          <label
            className={`input input-bordered flex items-center gap-2 mt-4 ${
              errors.deliverToEmail ? "input-error" : ""
            }`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          {errors.deliverToEmail && (
            <p className="text-red-500 text-sm mt-1">{errors.deliverToEmail}</p>
          )}
          ...
          <div className="mt-2">
            ...
            >
              {showDeliveryInstructions ? "Hide" : "+ Add"} extra delivery
              instructions
            </button>
            <div
              className={`${
                showDeliveryInstructions ? "block" : "hidden"
              } mt-2`}
            >
              <textarea
                ...
                onChange={(e) =>
                  onAdditionalDeliveryInstructionsChange(e.target.value)
                }
              />
            </div>
          </div>
      ...
      {/* Continue Button with Errors */}
      <div
        id="details-continue-section"
