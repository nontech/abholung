...
export default function TypeOfService({ serviceType, onServiceChange }: TypeOfServiceProps){
            ...
            <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-md">
                <div className="mb-6 flex items-center justify-center space-x-6">
                    <label className="flex items-center space-x-2">
                        ...
                        />
                        <div className="w-5 h-5 rounded-full border-2 border-green-600 flex items-center justify-center peer-checked:bg-green-600">
                ...
                <div className="mt-4 p-4 bg-gray-100 rounded-lg shadow-md text-center">
                    <p className="text-gray-800 text-md">You are <strong className="text-green-600">{serviceType}</strong> this product</p>
                </div>
            </div>
        </div>
    );
