  ...
  return (
    <div>
      <div className="flex items-center mb-4">
        <h1 className="text-xl font-bold text-gray-800">Kleinanzeigen Product Link</h1>
      ...
      <div className="mb-4 relative">
        <input
          ...
          className={`input input-bordered w-full ${ url ? 'text-black font-medium' : 'text-gray-500'}`}
          disabled={loading}
        />
